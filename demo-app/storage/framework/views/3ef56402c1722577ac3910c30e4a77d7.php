...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
    <div class="container mx-auto px-4 py-8">
        ...
        <!-- Setup Section -->
        <?php if($discounts->isEmpty() || $users->isEmpty()): ?>
            <div class="bg-yellow-50 border-l-4 border-yellow-500 p-6 mb-6 rounded shadow">
                ...
                <div class="flex gap-3">
                    <?php if($discounts->isEmpty()): ?>
                        <form action="<?php echo e(route('discount-demo.create-samples')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                    ...
                    <?php if($users->isEmpty()): ?>
                        <form action="<?php echo e(route('discount-demo.create-users')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="flex gap-2 items-center">
                        <span class="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-bold"><?php echo e($discounts->count()); ?> Total</span>
                        <?php if($discounts->isNotEmpty()): ?>
                            <form action="<?php echo e(route('discount-demo.delete-samples')); ?>" method="POST" onsubmit="return confirm('Delete all discounts and start fresh?')">
                                <?php echo csrf_field(); ?>
                ...
                <?php else: ?>
                    <div class="space-y-3 max-h-96 overflow-y-auto">
                        <?php $__currentLoopData = $discounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $discount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="border-2 rounded-lg p-4 <?php echo e($discount->is_active ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-gray-200'); ?> transition hover:shadow-md">
                                <div class="flex justify-between items-start">
                                    <div class="flex-1">
                                        <div class="font-bold text-lg text-gray-800"><?php echo e($discount->name); ?></div>
                                        <div class="text-sm text-gray-600 mt-1">
                                            <span class="font-mono bg-gray-200 px-2 py-1 rounded"><?php echo e($discount->code); ?></span>
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <div class="text-2xl font-bold text-blue-600">
                                            <?php echo e($discount->type === 'percentage' ? $discount->value . '%' : '$' . number_format($discount->value, 2)); ?>

                                        </div>
                                        <div class="text-xs text-gray-500"><?php echo e(ucfirst($discount->type)); ?></div>
                                    </div>
                                </div>
                                <div class="mt-3 flex flex-wrap gap-2 text-xs">
                                    <span class="bg-white px-2 py-1 rounded border">Max Usage: <?php echo e($discount->max_usage_per_user); ?></span>
                                    <span class="bg-white px-2 py-1 rounded border">Priority: <?php echo e($discount->priority); ?></span>
                                    <span class="px-2 py-1 rounded <?php echo e($discount->is_active ? 'bg-green-200 text-green-800' : 'bg-red-200 text-red-800'); ?>">
                                        <?php echo e($discount->is_active ? '✅ Active' : '❌ Inactive'); ?>

                                    </span>
                                    <?php if($discount->expires_at): ?>
                                        <span class="bg-orange-200 text-orange-800 px-2 py-1 rounded">
                                            Expires: <?php echo e($discount->expires_at->format('M d, Y')); ?>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="flex gap-2 items-center">
                        <span class="bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-sm font-bold"><?php echo e($users->count()); ?> Users</span>
                        <?php if($users->isNotEmpty()): ?>
                            <form action="<?php echo e(route('discount-demo.delete-users')); ?>" method="POST" onsubmit="return confirm('Delete all users? This will also remove their discount assignments.')">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <button type="submit" class="bg-red-500 text-white px-3 py-1 rounded-lg hover:bg-red-600 text-xs font-semibold">
                                    🗑️ Delete All
                    ...
                    <div class="space-y-2 max-h-96 overflow-y-auto">
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="border rounded-lg p-3 hover:bg-blue-50 transition cursor-pointer" 
                                 onclick="window.location='<?php echo e(route('discount-demo.user-status', $user->id)); ?>'">
        ...
        <?php if($discounts->isNotEmpty() && $users->isNotEmpty()): ?>
            <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
                <h2 class="text-2xl font-bold text-gray-800 mb-4">➕ Assign Discount to User</h2>
                
                <form action="<?php echo e(route('discount-demo.assign')); ?>" method="POST" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <?php echo csrf_field(); ?>
                        ...
                        <select name="discount_id" class="w-full border-2 border-gray-300 rounded-lg px-4 py-3 focus:border-blue-500 focus:outline-none" required>
                            ...
                            <?php $__currentLoopData = $discounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $discount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($discount->id); ?>">
                                    <?php echo e($discount->name); ?> - <?php echo e($discount->code); ?> (<?php echo e($discount->type === 'percentage' ? $discount->value . '%' : '$' . $discount->value); ?>)
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <a href="<?php echo e(route('discount-demo.audits')); ?>" 
            ...
            <?php if($users->isNotEmpty()): ?>
                <a href="<?php echo e(route('discount-demo.user-status', $users->first()->id)); ?>" 
            ...
            <a href="<?php echo e(route('discount-demo.index')); ?>" 
    ...
    <script>
        ...
        function calculateDiscount() {
            ...
            $.post('<?php echo e(route("discount-demo.calculate")); ?>', {
                user_id: userId,
                amount: amount
            }, function(data) {
        ...
        function applyDiscount() {
            ...
            $.post('<?php echo e(route("discount-demo.apply")); ?>', {
                user_id: userId,
                amount: amount
            }, function(data) {
...
<?php /**PATH /var/www/html/laravel/taskb/demo-app/resources/views/discount-demo/index.blade.php ENDPATH**/ ?>